...
| 维度     | 验收方式                                                                           | 现状                                                                                                                                                                                                                |
| -------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 功能对齐 | App 集成套件 + 各能力差分语料（权限、Bash、代理、prompt 等）                       | 三平台 CI 243 用例通过（2026-09-25）；**仍缺**：WebFetch/WebSearch、Edit 宽松匹配、output style、大图缩放/媒体 Read、MCP OAuth、自定义斜杠命令、主代理记忆索引/提取；工作流/Cron/自动任务按用户决定声明 unsupported |
