// Run with TSX_TSCONFIG_PATH=packages/services/tests/tsconfig.rust-agent.json node --import tsx.
...
import { fixture } from "../packages/services/tests/rust-agent-fixture.ts";
