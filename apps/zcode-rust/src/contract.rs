...
pub use crate::domain::model::{ModelFailure, RetryState};
...
pub struct ChildHandle {
    pub task: crate::domain::subagent::Task,
    pub updates: tokio::sync::watch::Receiver<crate::domain::subagent::Task>,
...
pub enum Input {
    Request(crate::domain::protocol::Request),
...
pub trait SessionStore: Send + Sync {
    ...
    async fn list_sessions(
        &self,
        _params: &crate::domain::session_listing::ListParams,
        _owner: (&str, &str),
    ...
    async fn read_attachment(
        &self,
        _asset: &crate::domain::session::StoredAttachment,
        _offset: u64,
        _limit: usize,
    ) -> Result<Vec<u8>> {
...
pub trait ToolPort: Send + Sync {
    async fn file_changes(
        &self,
        _changes: &[crate::domain::file_checkpoint::FileCheckpoint],
    ) -> Result<Value> {
    ...
    async fn agent_memory(
        &self,
        _profile: &crate::domain::subagent::Profile,
    ...
    async fn agent_profiles(
        ...
        Ok(crate::domain::subagent::builtins())
    }
    ...
    async fn load_skill(
        &self,
        _skill: &crate::domain::skills::Skill,
        _name: &str,
        _cancel: &CancellationToken,
    ) -> Result<ToolOutput> {
